...
<head>
    ...
    <%
        String status1=user.getUserType().equals("0")?"学校":"企业";
        String status2=user.getUserType().equals("0")?"学号":"企业地址";
    %>
</head>
<body>
<div>
...
<div style="border: solid 1px #989898 ;margin-top: 10px;">
    <div class="container-left">
        <img src="userInfo/getImg?userName=<%=user.getUserName()%>" style="margin-top: 50px;cursor: pointer" onclick="getImg()">
    ...
    <div class="container-right">
        ...
        <form class="form-left" action="uploadInfo" method="post">
            ...
            <table class="basic-table">
                <tr><td class="basic-table-left">用户名：</td><td class="basic-table-right special-text" id="user-name-label" ><%--<input id="user-name-label" type="text" name="userName" value="--%><%=user.getUserName()%><%--">--%></td></tr>
                <tr><td class="basic-table-left">账号：</td><td class="basic-table-right special-text" id="user-id-label"><%--<input type="number" readonly="readonly" value="--%><%=user.getUserId()%><%--">--%></td></tr>
                <tr><td class="basic-table-left">手机号码：</td><td class="basic-table-right special-text" id="user-phone-label"><%--<input id="user-phone-label" type="number" name="phoneNum" value="--%><%=user.getPhoneNum()%><%--">--%></td></tr>
                <tr><td class="basic-table-left">电子邮箱：</td><td class="basic-table-right special-text" id="user-email-label"><%--<input id="user-email-label" type="email" name="email" value="--%><%=user.getEmailAddress()%><%--">--%></td></tr>
            </table>
        </form>
        ...
        <form class="form-right" action="uploadActual" method="post">
            ...
            <table class="basic-table">
                <tr><td class="basic-table-left"><%=status1%>：</td><td class="basic-table-right  special-text" id="com-name-label"><%--<input class="special-text" type="text" readonly="readonly" value="--%><%=user.getStatus1()%><%--">--%></td></tr>
                <tr><td class="basic-table-left"><%=status2%>：</td><td class="basic-table-right special-text" id="com-addr-label"><%--<input class="special-text" type="text" readonly="readonly" value="--%><%=user.getStatus2()%><%--">--%></td></tr>
                <tr><td class="basic-table-left">真实姓名：</td><td class="basic-table-right special-text" id="user-real-label"><%--<input class="special-text" type="text" readonly="readonly" value="--%><%=user.getRealName()%><%--">--%></td></tr>
                <%--<tr><td class="basic-table-left">身份证号码：</td><td class="basic-table-right special-text" id="user-card-label">&lt;%&ndash;<input class="special-text" type="text" readonly="readonly" value="&ndash;%&gt;<%=user.getIdCard()%>&lt;%&ndash;">&ndash;%&gt;</td></tr>--%>
            </table>
        </form>
    </div>
...
<script type="text/javascript" language="JavaScript">
    ...
    function changeInfo() {
        document.cookie="web_userName="+user_name_label.value+";path=/webLab";
    ...
    function getImg(){
        window.open("userInfo/getImg?userName=<%=user.getUserName()%>");
    }
