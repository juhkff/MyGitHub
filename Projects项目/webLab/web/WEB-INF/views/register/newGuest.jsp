...
<head>
    ...
    <script type="text/javascript" charset="UTF-8" src="${pageContext.request.contextPath}/js/newGuest.js"></script>
</head>
<body>
<div class="container">
    ...
    <table>
        <tr>
            <td class="td_left">企业：</td><td class="td_right"><input type="text" placeholder="企业名"></td>
        </tr>
        <tr>
            <td class="td_left">企业地址：</td><td class="td_right"><input type="text" placeholder="企业地址"></td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="td_left">性别：</td><td class="td_right"><input class="i_radio" type="radio" name="sex" value="M">男</input><input class="i_radio" type="radio" name="sex" value="F">女</input></td>
        </tr>
    </table>
    <div class="separator"></div>
