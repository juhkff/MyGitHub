...
public class Project_Show {
    ...
    public ArrayList<Project_In_Show> getProjectList() {
        ...
        String sql = "SELECT ProName,ProTags,ProFounder,ProContent FROM projects WHERE IsRequired=?";
        try {
    ...
    public ArrayList<Project_In_Show> searchProjects(String proTags) {
        if (proTags.equals("")) {
            ...
            Connection connection = myConnection.getConnection();
            PreparedStatement preparedStatement = null;
            String sql = "SELECT ProName,ProTags,ProFounder,ProContent FROM projects WHERE IsRequired=0 ";
